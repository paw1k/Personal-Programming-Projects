...
//import sun.audio.*;   //***couldn't figure it out to work
...
public class Tetris extends JPanel {
    ...
    public Tetris() {
      ...
      SoundEffect.init();  // to play the sound
      SoundEffect.gameSound.play();   // plays the sound
        ...
        JRadioButton soundButton =new JRadioButton("SOUND");
        soundButton.setBounds(475, 415, 141, 23);
        add(soundButton);
